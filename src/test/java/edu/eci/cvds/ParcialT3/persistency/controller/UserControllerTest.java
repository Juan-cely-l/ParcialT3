...
import edu.eci.cvds.ParcialT3.persistency.dto.UserDto;
import edu.eci.cvds.ParcialT3.persistency.entity.User;
import edu.eci.cvds.ParcialT3.persistency.security.JwtUtil;
import edu.eci.cvds.ParcialT3.persistency.service.UserService;
...
class UserControllerTest {
    ...
    void testSaveUserSuccess() throws Exception {
        UserDto userDto = new UserDto("Andres Silva", "AndresSilva@gmail.com", DoctorSpeciality.TEACHER, "password");
        User user = new User(1, "Andres Silva", "AndresSilva@gmail.com", DoctorSpeciality.TEACHER, "hashedPassword");
    ...
    void testSaveUserFailure() throws Exception {
        UserDto userDto = new UserDto("Error User", "error@example.com", DoctorSpeciality.TEACHER, "password");
    ...
    void testFindAllUsersSuccess() throws Exception {
        User user1 = new User(1, "Andres Silva", "AndresSilva@gmail.com", DoctorSpeciality.TEACHER, "hashedPassword");
        User user2 = new User(2, "Juan Lopez", "JuanLopez@gmail.com", DoctorSpeciality.TEACHER, "hashedPassword");
    ...
    void testDeleteUserSuccess() throws Exception {
        Integer userId = 1;
        User deletedUser = new User(userId, "Test User", "test@example.com", DoctorSpeciality.TEACHER, "hashedPassword");

...
class UserServiceTest {
    ...
    void testGetAllUsersSuccess() {
        User user1 = new User(1, "Andres Silva", "AndresSilva@gmail.com", DoctorSpeciality.TEACHER, "hashedPassword1");
        User user2 = new User(2, "Maria Lopez", "MariaLopez@gmail.com", DoctorSpeciality.ADMIN, "hashedPassword2");
    ...
    void testAuthenticateSuccess() {
        ...
        User user = new User(1, "Andres Silva", email, DoctorSpeciality.TEACHER, hashedPassword);

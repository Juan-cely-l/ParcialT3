package edu.eci.cvds.ParcialT3.persistency.security;
...
class JwtUtilTest {
    ...
    void setUp() {
        ...
        when(mockUser.getRole()).thenReturn(DoctorSpeciality.ADMIN);
    ...
    void testExtractRole() {
        ...
        Assertions.assertEquals(mockUser.getRole().name(), role, "El rol extraído del token debe coincidir con el del usuario");
    }

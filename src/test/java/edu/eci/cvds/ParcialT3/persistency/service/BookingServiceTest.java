...
import edu.eci.cvds.ParcialT3.persistency.repository.BookingRepository;
...
class BookingServiceTest {
    ...
    void testGetAllBookingsSuccess() {
        ...
        Booking booking2 = new Booking(2, 10000097, LocationName.FUNDAMENTOS, Day.LUNES, Hour.ONCE_TREINTA, Hour.UNA, BookingStatus.AVAILABLE);
    ...
    void testAutoIncrementSuccess() {
        ...
        BookingDto bookingDto = new BookingDto(10000087, LocationName.FUNDAMENTOS, Day.LUNES, Hour.ONCE_TREINTA, Hour.UNA, BookingStatus.AVAILABLE);
        Booking newBooking = new Booking(2, 10000097, LocationName.FUNDAMENTOS, Day.LUNES, Hour.ONCE_TREINTA, Hour.UNA, BookingStatus.AVAILABLE);
    ...
    void testAutoIncrementFailure() {
        ...
        Integer newId = bookingService.save(new BookingDto(10000087, LocationName.FUNDAMENTOS, Day.LUNES, Hour.ONCE_TREINTA, Hour.UNA, BookingStatus.AVAILABLE)).getId();
